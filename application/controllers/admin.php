    ...
    redirect('admin/data_pengampu');
     ...
     public function add_pengampu() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!$this->m_pengampu->cek_duplikat($id_dosen, $id_matkul, $id_kelas)) {
                ...
                $this->m_pengampu->insert_data($data_insert);
    
                $this->session->set_flashdata('success-reg', 'Berhasil Ditambahkan!');
            } else {
                $this->session->set_flashdata('error-reg', 'Data sudah ada!');
            }
            
            $this->session->set_flashdata('success', 'Data pengampu berhasil ditambahkan');
