...
<body>
    ...
    <a href="<?=base_url('welcome')?>"> 
        <img src="<?=base_url('assets/')?>/img/logo.png" alt="logo" width="100" class="mb-5 mt-2">
    </a>
</div>

                        <h4 class="text-dark font-weight-normal">
                            <span class="font-weight-bold"> PENJADWALAN MATA KULIAH TEKNIK INFORMATIKA ITI </span>
                        </h4>
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb"
                                target="_blank" href="https://xead.my.id/">JonathanZefanya</a> - Image by <a
