...
<head>
    ...
    <title>Data Penjadwalan - ITI</title>
...
?></div>
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <a href="<?=base_url('admin')?>" class="text-success text-center">
                            <i class="fas fa-graduation-cap"></i> | ITI
                        </a>
                    </div>
    ...
    <footer class="main-footer">
        <div class="footer-left">
            Copyright &copy; 2020 <div class="bullet"></div> Code & Design by <a href="https://syauqizaidan.github.io/">Jonathan Zefanya</a>
        </div>
