                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data Admin ITI</h2>
                                <hr>
                                <p class="card-text"> Jumlah admin yang terdaftar di Institut Teknologi Indonesia sekarang adalah <span
