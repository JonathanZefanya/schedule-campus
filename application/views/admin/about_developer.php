                ...
                <section class="section">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tentang Jonathan Zefanya Zaaidan</h2>
                                <hr>
                                <p class="card-text">Jonathan Zefanya Zaaidan merupakan junior programmmer yang membuat project
